...
#                },
    ...
    security.declareProtected(ZEN_COMMON, 'getGeomapData')
    ...
    security.declareProtected(ZEN_COMMON, 'getChildGeomapData')
    @json
    ...
    security.declareProtected(ZEN_COMMON, 'getSecondaryNodes')
